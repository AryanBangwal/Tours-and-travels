...
<head>
  ...
  <style>
    ...
    .section-icons {
    background-image: url('<?php echo e(asset('images/new5.jpg')); ?>'); /* Use your desired image here */
    ...
    <div class="swiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <img src="<?php echo e(asset('images/goa.jpg')); ?>" alt="Goa" />
        </div>
        <div class="swiper-slide">
          <img src="<?php echo e(asset('images/manali.jpg')); ?>" alt="Manali" />
        </div>
        <div class="swiper-slide">
          <img src="<?php echo e(asset('images/rameshwaram.jpg')); ?>" alt="Rameshwaram" />
        </div>
      </div>
    </div>
      ...
      <div class="row" style="display: flex; flex-wrap: wrap; gap: 2rem; justify-content: center;">
        <div class="col s12 m4">
          <div class="popular-card">
            <img src="<?php echo e(asset('images/goa.jpg')); ?>" alt="goa image" style="width: 100%; height: 240px; object-fit: cover; border-radius: 0.5rem; margin-bottom: 1rem;">
            <h4>GOA</h4>
        ...
        <div class="col s12 m4">
          <div class="popular-card">
            <img src="<?php echo e(asset('images/new2.png')); ?>" alt="goa image" style="width: 100%; height: 240px; object-fit: cover;">
            <h4>Rameshwaram</h4>
        ...
        <div class="col s12 m4">
          <div class="popular-card">
            <img src="<?php echo e(asset('images/new3.jpg')); ?>" alt="goa image" style="width: 100%; height: 240px; object-fit: cover;">
            <h4>Manali</h4>
...
<?php /**PATH C:\Users\aryan\Git-Projects\tours-and-travels\resources\views/pages/homepage.blade.php ENDPATH**/ ?>